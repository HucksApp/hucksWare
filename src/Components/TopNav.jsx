...
const prop = usepring({
    ...
    if(!state){
        btn = <animated.div style={prop}><MenuTwoToneIcon style={{color:props.color_type,fontSize: "60px"}} onClick={()=>toggleDrawer(true)}/></animated.div>
    }else if(state){
                        
        btn = <animated.div style={prop}><CloseIcon style={{color:props.color_type,fontSize: "60px"}} /></animated.div>
                    }
